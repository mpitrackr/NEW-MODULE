odoo.define('inventory_barcode.MainMenu', function (require) {
"use strict";
...
var MainMenu = AbstractAction.extend({
    ...
    events: {
        "click .button_operations": function(){
            this.do_action('inventory_barcode.stock_picking_type_action_kanban');
        },
        "click .button_inventory": function(){
            this.open_inventory();
        },
        "click .o_inventory_barcode_menu": function(){
            ...
            var options = {
                ...
                buttons: [
                    { text: _t("Remove it"), close: true, classes: 'btn-primary', click: function() {
                        Session.rpc('/inventory_barcode/rid_of_message_demo_barcodes');
                    }},
    ...
    _onBarcodeScanned: function(barcode) {
        ...
        Session.rpc('/inventory_barcode/scan_from_main_menu', {
            barcode: barcode,
...
core.action_registry.add('inventory_barcode_main_menu', MainMenu);
