odoo.define('inventory_barcode.picking_client_action', function (require) {
'use strict';

var core = require('web.core');
var ClientAction = require('inventory_barcode.ClientAction');
...
var PickingClientAction = ClientAction.extend({
    ...
    _getWriteableFields: function () {
        return ['qty_done', 'location_id.id', 'location_dest_id.id', 'lot_name', 'lot_id.id', 'result_package_id','lot_production_date'];
    },
        ...
        for (var i in changes) {
            ...
            if (line.id) {
                ...
                cmd = [1, line.id, {
                    ...
                    'lot_production_date':line.lot_production_date,
    ...
    _showInformation: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            self.ViewsWidget = new ViewsWidget(
                self,
                'stock.picking',
                'inventory_barcode.stock_picking_barcode',
                {},
    ...
    _onOpenPackage: function (ev) {
        ...
        this.mutex.exec(function () {
            return self._save().then(function () {
                ...
                self.ViewsWidget = new ViewsWidget(self, 'stock.quant', 'inventory_barcode.stock_quant_barcode_kanban', {}, params, false, 'kanban');
...
core.action_registry.add('inventory_barcode_picking_client_action', PickingClientAction);
