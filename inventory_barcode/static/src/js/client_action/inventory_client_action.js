odoo.define('inventory_barcode.inventory_client_action', function (require) {
'use strict';
    ...
    _showInformation: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            self.ViewsWidget = new ViewsWidget(
                self,
                'stock.inventory',
                'inventory_barcode.stock_inventory_barcode2',
                {},
...
core.action_registry.add('inventory_barcode_inventory_client_action', InventoryClientAction);
