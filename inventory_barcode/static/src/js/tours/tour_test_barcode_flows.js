...
tour.register('test_receipt_from_scratch_with_lots_1', {test: true}, [
...

    {
        trigger: '.o_barcode_client_action',
        run: function () {
            assertErrorMessage('You are expected to scan one or more products.  tour_test_barcode_flows.js line 1391 ');
        },
    },
...
tour.register('test_receipt_duplicate_serial_number', {test: true}, [
    ...
    */
    {
        trigger: '.o_inventory_barcode_main_menu:contains("Barcode Scanning")',
    },
    // reception
    {
        trigger: '.o_inventory_barcode_main_menu',
