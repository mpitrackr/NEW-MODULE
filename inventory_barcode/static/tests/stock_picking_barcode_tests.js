odoo.define('inventory_barcode.stock_picking_barcode_tests', function (require) {
"use strict";
...
QUnit.module('inventory_barcode', {}, function () {
...
QUnit.module('Barcode', {
    beforeEach: function () {
        ...
        this.clientData = {
            action: {
                tag: 'inventory_barcode_picking_client_action',
        ...
        this.mockRPC = function (route, args) {
            if (route === '/inventory_barcode/get_set_barcode_view_state') {
